...
<ol>
  ...
  <p>This folder provides all the data and code to create the new test and trained dataset. Within the folder are the original dataset, the mutation data, the code to create the new training and test set</p> Mutation data merge with pathway scores and drug descriptors was done in 3 steps. <br>
